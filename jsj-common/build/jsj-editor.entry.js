import { r as registerInstance, e as createEvent, h, f as Host, g as getElement } from './index-fda278ee.js';
...
const Quill = /*@__PURE__*/getDefaultExportFromCjs(quill);
...
const jsjEditorCss = ".sc-jsj-editor-h{display:block}";

const JsjEditor = class {
  constructor(hostRef) {
  ...
  componentDidLoad() {
    ...
    if (window && window.document)
      loadStyle('https://cdn.quilljs.com/1.3.7/quill.snow.css');
...
JsjEditor.style = jsjEditorCss;

export { JsjEditor as jsj_editor };
